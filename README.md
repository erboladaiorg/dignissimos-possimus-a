# @erboladaiorg/dignissimos-possimus-a
...
### Install
`npm i @erboladaiorg/dignissimos-possimus-a`
...
```javascript
const {CStructBE,CStructLE, hexToBuffer, AtomTypes} = require('@erboladaiorg/dignissimos-possimus-a');
...
**Make example**<br>
```typescript
import { CStructBE, CStructProperty } from '@erboladaiorg/dignissimos-possimus-a';
...
```typescript
import { CStructBE, CStructClass } from '@erboladaiorg/dignissimos-possimus-a';
...
### [Many examples are in this folder '/examples'](https://github.com/erboladaiorg/dignissimos-possimus-a/tree/main/examples)

### Basic examples
```typescript
import { CStructBE } from '@erboladaiorg/dignissimos-possimus-a';
...
**NOTE** Take a look on ['/examples/decorators.ts'](https://github.com/erboladaiorg/dignissimos-possimus-a/tree/main/examples/decorators.ts)
...
```typescript
import { CStructBE, CStructClass, CStructModelProperty } from '@erboladaiorg/dignissimos-possimus-a';
...
### [TODO](https://github.com/erboladaiorg/dignissimos-possimus-a/blob/main/doc/TODO.md)
